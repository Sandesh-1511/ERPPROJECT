// src/pages/accountant/Profile.jsx
              ...
              <Form>
                <Row>
                  ...
                  <Col md={6} className="mb-3">
                    ...
                    <Form.Control defaultValue="Accountant" readOnly />
                  </Col>
                </Row>
                ...
                <Row>
                  <Col md={6} className="mb-3">
                    ...
                    <Form.Control defaultValue="Accounts" />
                  </Col>
                  <Col md={6} className="mb-3">
                    <Form.Label>Employee ID</Form.Label>
                    <Form.Control defaultValue="ACC-101" readOnly />
                  </Col>
                </Row>
