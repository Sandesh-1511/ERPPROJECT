...
// //         fontSize: "0.95rem",
// //         background: isActive
// //           ? "rgba(255, 255, 255, 0.2)"   // semi-transparent for blur
// //           : "transparent",                // or "rgba(0,0,0,0.1)" if you want subtle bg
...
// //         <hr className="my-3 opacity-10" style={{ borderColor: theme.dividerColor }} />
...
const getMenuByRole = (role) => {
  const items = {
    principal: [
      { name: "Dashboard", path: "/dashboard/principal", icon: "ri-dashboard-3-line" },
      { name: "Students", path: "/dashboard/principal/students", icon: "ri-group-line" },
      { name: "Fee Management", path: "/dashboard/principal/fees", icon: "ri-money-rupee-circle-line" },
      { name: "Examinations", path: "/dashboard/principal/exams", icon: "ri-file-list-3-line" },
      { name: "Academic", path: "/dashboard/principal/academic", icon: "ri-book-open-line" },
      { name: "Staff", path: "/dashboard/principal/staff", icon: "ri-user-star-line" },
      { name: "Departments", path: "/dashboard/principal/departments", icon: "ri-building-4-line" },
      { name: "Reports", path: "/dashboard/principal/reports", icon: "ri-bar-chart-box-line" },
      { name: "Profile", path: "/dashboard/principal/principal-profile", icon: "ri-user-settings-line" },
    ],

    teacher: [
      { name: "Dashboard", path: "/dashboard/teacher", icon: "ri-dashboard-3-line" },
      { name: "My Classes", path: "/dashboard/teacher/classes", icon: "ri-school-line" },
      { name: "Students", path: "/dashboard/teacher/students", icon: "ri-user-3-line" },
      { name: "Assignments", path: "/dashboard/teacher/assignments", icon: "ri-task-line" },
      { name: "Timetable", path: "/dashboard/teacher/timetable", icon: "ri-calendar-line" },
      { name: "Profile", path: "/dashboard/teacher/profile", icon: "ri-user-line" },
      { name: "My Profile", path: "/dashboard/profile", icon: "ri-id-card-line" },
    ],

    librarian: [
      { name: "Dashboard", path: "/dashboard/librarian", icon: "ri-dashboard-3-line" },
      { name: "Books", path: "/dashboard/librarian/books", icon: "ri-book-2-line" },
      { name: "Issue Books", path: "/dashboard/librarian/issue", icon: "ri-share-forward-line" },
      { name: "Members", path: "/dashboard/librarian/members", icon: "ri-team-line" },
      { name: "Reports", path: "/dashboard/librarian/reports", icon: "ri-bar-chart-2-line" },
    ],

    accounts_staff: [
      { name: "Dashboard", path: "/dashboard/accounts_staff", icon: "ri-dashboard-3-line" },
      { name: "Fees", path: "/dashboard/accountant/fees", icon: "ri-receipt-line" },
      { name: "Expenses", path: "/dashboard/accountant/expenses", icon: "ri-file-text-line" },
      { name: "Salary", path: "/dashboard/accountant/salary", icon: "ri-wallet-3-line" },
      { name: "Reports", path: "/dashboard/accountant/reports", icon: "ri-pie-chart-line" },
      { name: "My Profile", path: "/dashboard/profile", icon: "ri-user-line" },
    ],
  };
...
const renderMenuItems = (menuItems, isMobile = false, onClose) => {
  return menuItems.map((item, i) => (
    <NavLink
      ...
      to={item.path}
      className={({ isActive }) =>
        `d-flex align-items-center text-decoration-none p-3 rounded-3 mb-2
        ${isActive ? "text-light fw-bold" : "text-light"}`
      }
      style={({ isActive }) => ({
        fontSize: "0.95rem",
      ...
      >
        <div className="mb-4 text-center">
          <div className="d-flex align-items-center gap-2">      
            <i className="ri-graduation-cap-line fs-1 text-light"></i>
            <h5 className="text-light fs-3 fw-bold mb-1">School ERP</h5>
          </div>
          <p className="text-light small mb-0 text-capitalize">
            {role || "User"} Portal
